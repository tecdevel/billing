...
public class PaymentEmailAuthorizeNetTask extends PaymentAuthorizeNetTask {
    ...
    public boolean process(PaymentDTOEx paymentInfo) 
        ...
        FormatLogger log = new FormatLogger(PaymentEmailAuthorizeNetTask.class);
        ...
        try {
            ...
            String message;
            if (new Integer(paymentInfo.getPaymentResult().getId()).equals(ServerConstants.RESULT_OK)) {
