...
public class BillingProcessRunBL  extends ResultList {
    ...
    public class DateComparator implements Comparator<ProcessRunDTO> {
        @Override
        public int compare(ProcessRunDTO a, ProcessRunDTO b) {
    ...
    public Integer create(BillingProcessDTO process, Date runDate) {
        ...
        billingProcessRun = processRunDas.create(process, runDate, 0,
                new ProcessRunStatusDAS().find(CommonConstants.PROCESS_RUN_STATUS_RINNING));
    ...
    public ProcessStatusWS getBillingProcessStatus(Integer entityId) {
        ...
        if (processRunDTO == null) {
            ...
            } else if (processRunDTO.getStatus().getId() == CommonConstants.PROCESS_RUN_STATUS_RINNING) {
                result.setState(ProcessStatusWS.State.RUNNING);
            } else if (processRunDTO.getStatus().getId() == CommonConstants.PROCESS_RUN_STATUS_FAILED) {
