...
public class PaymentSageTask extends PaymentTaskWithTimeout implements
    ...
    private static final FormatLogger LOG = new FormatLogger(PaymentSageTask.class);
        ...
        if (isAch) {
            ...
            request
                    .add(
                            ...
                            accountType.equalsIgnoreCase(ServerConstants.ACH_CHECKING) ? SageValues.BankAccountType.CHECKING
    ...
    private class SageAuthorization {
        ...
        public Integer getJBResultId() {
            ...
            return SageValues.ApprovalIndicator.APPROVED
                    .equalsIgnoreCase(paymentAuthDTO.getCode1()) ? ServerConstants.RESULT_OK
                    : ServerConstants.RESULT_FAIL;
        }
