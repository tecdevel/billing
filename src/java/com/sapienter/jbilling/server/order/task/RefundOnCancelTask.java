...
public class RefundOnCancelTask extends PluggableTask implements IInternalEventsTask {
    ...
    private static final FormatLogger LOG = new FormatLogger(RefundOnCancelTask.class);
    ...
    public void process(Event event) {
        ...
        for (String name : parameters.keySet()) {
            ...
            newLine.setOrderLineType(new OrderLineTypeDAS().find(ServerConstants.ORDER_LINE_TYPE_ITEM));
