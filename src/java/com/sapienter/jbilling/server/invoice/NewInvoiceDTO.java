...
public class NewInvoiceDTO extends InvoiceDTO {
    ...
    private static final FormatLogger LOG = new FormatLogger(NewInvoiceDTO.class);
    ...
    public void addOrder(OrderDTO order, Date start, Date end, List<PeriodOfTime> periods) throws SessionInternalError {
        new FormatLogger(NewInvoiceDTO.class).debug("Adding order %d to new invoice", order.getId());
        orders.add(order);
